...
class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String AUTHORITIES_BY_USERNAME =
            "select werknemers.email as username, jobtitels.naam as authorities from werknemers inner join jobtitels" +
                    " on werknemers.jobtitelid = jobtitels.id where werknemers.email= ?";
